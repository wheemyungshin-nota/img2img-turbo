...
def main(args):
    ...
    dataset_train = PairedDataset(dataset_folder=args.dataset_folder, image_prep=args.train_image_prep, input_image_prep=args.input_image_prep, split="train", tokenizer=net_pix2pix.tokenizer, prompt_name=args.prompt_name)
